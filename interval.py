...
if __name__ == '__main__':
    ...
    times = [
        ['影宝e', 1.067, 1.016, 1.202, 1.05, 1.167, 1.133, 1.15, 0.999, 1.133, 1.15, 0.866, 0.967],
        ['切芙芙出来', 0.283, 0.217, 0.367, 0.3, 0.2, 0.183, 0.25, 0.235, 0.183,  0.202, 0.217, 0.283],
        ['芙芙大招动画开始', 0.833, 0.867, 0.85, 0.784, 0.783, 0.9, 0.75, 0.733, 0.75, 0.883, 0.9, 0.9],
        ['芙芙大招动画结束', 1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 1.9, 1.9],
        ['切夜兰出来', 0.35, 0.45, 0.433, 0.467, 0.4, 0.533, 0.45, 0.4, 0.467, 0.4, 0.4],
        ['夜兰e生效一层', 0.767, 0.749, 0.766, 0.767, 0.75, 0.767, 0.734, 0.783, 0.784, 0.75, 0.75, 0.783],
        ['夜兰大招动画开始', 0.167, 0.133, 0.167, 0.116, 0.1, 0.133, 0.117, 0.15, 0.133],
        ['夜兰大招动画结束', 1.5, 1.517, 1.5, 1.502, 1.552, 1.517, 1.5, 1.5, 1.482, 1.517, 1.5, 1.5],
        ['夜兰e生效一层', 0.684, 0.718, 0.783, 0.817, 0.835, 0.818, 0.735, 0.834, 0.8, 0.7, 0.733],
        ['切琴出来', 0.301, 0.25, 0.233, 0.234, 0.417, 0.233, 0.317, 0.333, 0.419, 0.283, 0.334],
        ['琴大招动画开始', 1.733, 1.767, 1.7, 1.817, 1.566, 1.534, 1.633, 1.399, 1.633, 1.533],
        ['琴奶全队时间', 0.717, 0.683, 0.7, 0.683, 0.75, 0.7, 0.767, 0.783, 0.7, 0.7, 0.734, 0.767],
        ['琴大招动画结束', 1.433, 1.433, 1.451, 1.433, 1.433, 1.433, 1.467, 1.433, 1.433, 1.45, 1.435, 1.435],
        ['切影宝出来', 0.9, 0.9, 1.133, 0.983, 1.034],
        ['影宝大招动画开始', 0.083, 0.083, 0.084, 0.083, 0.083, 0.083, 0.083, 0.083],
        ['影宝大招动画结束', 1.834, 1.817, 1.833, 1.8, 1.818, 1.817, 1.817, 1.833]
    ]

    for i in range(0, len(times)):
        times[i] = times[i][0:1] + sorted(times[i][1:])
