...
bing_tao = [
    ...
    ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_SHA, crit_rate=0.097, hp=209, crit_damage=0.202, def_v=42),
    ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_BEI, atk_per=0.192, hp=299, energe_recharge=0.11, atk=16),
    ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_TOU, crit_rate=0.311, atk_per=0.152, elem_mastery=44, crit_damage=0.148),
    ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_TOU, crit_damage=0.622, hp=239, elem_mastery=16, crit_rate=0.086, def_v=60),
]

syw_s_b = {
   "s": [
        ShengYiWu('huahai', ShengYiWu.PART_SHA, crit_damage=0.21, hp=568, crit_rate=0.078, hp_percent=0.093),
        ShengYiWu('shenlin', ShengYiWu.PART_SHA, crit_rate=0.109, def_v=32, crit_damage=0.233, hp=209),
        ShengYiWu('shenlin', ShengYiWu.PART_SHA, hp=269, def_v=37, crit_damage=0.124, crit_rate=0.132),
        ShengYiWu('jueyuan', ShengYiWu.PART_SHA, elem_mastery=19, hp_percent=0.105, crit_rate=0.086, crit_damage=0.202),
        ShengYiWu('yuetuan', ShengYiWu.PART_SHA, def_per=0.124, crit_rate=0.101, crit_damage=0.132, atk=19),
        ShengYiWu('bingtao', ShengYiWu.PART_SHA, crit_rate=0.097, hp=209, crit_damage=0.202, def_v=42),
    ],
    "b": [
        ShengYiWu('shenlin', ShengYiWu.PART_BEI, hp=239, crit_rate=0.066, atk_per=0.21, atk=37),
        ShengYiWu('chenlun', ShengYiWu.PART_BEI, def_per=0.058, crit_rate=0.07, crit_damage=0.218, atk=33),
        ShengYiWu('bingtao', ShengYiWu.PART_BEI, atk_per=0.192, hp=299, energe_recharge=0.11, atk=16),
        ShengYiWu('huahai', ShengYiWu.PART_BEI, atk=35, atk_per=0.111, elem_mastery=19, crit_rate=0.128),
    ],
}
...
def calculate_score(combine):
    ...
    score = all_atk / base_atk * (base_crit_damage + extra_crit_damage) / base_crit_damage
    data = [int(panel_atk), round(crit_rate, 3), round(base_crit_damage + extra_crit_damage - 1, 3), round(total_energe_recharge, 1), combine]
