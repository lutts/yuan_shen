...
shen_lin = [
    ...
    ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_SHA, crit_damage=0.124,
              hp_percent=0.198, energe_recharge=0.11, def_v=11),
    ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_SHA,
              energe_recharge=0.045, crit_rate=0.093, hp=508, def_per=0.124),

    ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_BEI, hp_percent=0.163,
              energe_recharge=0.045, elem_mastery=40, crit_rate=0.074),
...
syw_s_b = {
    ShengYiWu.PART_SHA: [
        ShengYiWu(ShengYiWu.LIE_REN, ShengYiWu.PART_SHA, def_per=0.073,
                  crit_rate=0.128, crit_damage=0.148, hp_percent=0.041),
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_SHA,
                  atk_per=0.058, def_v=19, crit_damage=0.062, crit_rate=0.152),
        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_SHA,
                  atk_per=0.14, def_v=35, crit_rate=0.062, atk=19),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_SHA, crit_damage=0.124,
                  hp_percent=0.198, energe_recharge=0.11, def_v=11),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_SHA,
                  energe_recharge=0.045, crit_rate=0.093, hp=508, def_per=0.124),
        ShengYiWu(ShengYiWu.ZHUI_YI, ShengYiWu.PART_SHA, atk=27,
                  crit_damage=0.218, energe_recharge=0.104, atk_per=0.041),
        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_SHA, hp=538,
                  crit_rate=0.062, crit_damage=0.202, hp_percent=0.058),
        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_SHA, energe_recharge=0.052,
                  crit_damage=0.202, crit_rate=0.101, def_v=19),
    ],
    ShengYiWu.PART_BEI: [
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_BEI,
                  crit_rate=0.101, elem_mastery=19, crit_damage=0.179, hp=209),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_BEI, hp_percent=0.163,
                  energe_recharge=0.045, elem_mastery=40, crit_rate=0.074),
        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_BEI,
                  elem_mastery=54, atk_per=0.053, atk=33, crit_damage=0.155),
        ShengYiWu(ShengYiWu.CHEN_LUN, ShengYiWu.PART_BEI, crit_damage=0.21,
                  elem_mastery=116, def_v=32, hp_percent=0.099),
        ShengYiWu('qi_shi', ShengYiWu.PART_BEI, elem_mastery=40,
                  energe_recharge=0.058, crit_damage=0.241, hp_percent=0.047),
    ]
}
...
def calculate_score(combine):
    ...
    non_crit_score = (atk_bei_lv * all_atk + elem_bei_lv * elem_mastery) / (atk_bei_lv *
                                                                            base_atk + elem_bei_lv * base_elem_mastery) * elem_bonus / base_elem_bonus
    crit_score = non_crit_score * \
        (base_crit_damage + extra_crit_damage) / base_crit_damage
    expect_crit_damage_bonus = crit_rate * \
        (extra_crit_damage + base_crit_damage - 1)
