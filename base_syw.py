...
all_syw = {
    ShengYiWu.PART_HUA: [
        ...
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_HUA,
                  crit_rate=0.035, crit_damage=0.249, energe_recharge=0.117, atk_per=0.099),
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_HUA,
    ...
    ShengYiWu.PART_YU: [
        ...
        ShengYiWu(ShengYiWu.LIE_REN, ShengYiWu.PART_YU,
                  hp=239, energe_recharge=0.065, crit_damage=0.132, hp_percent=0.181),
        ...
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_YU,
                  hp_percent=0.058, crit_rate=0.062, crit_damage=0.132, energe_recharge=0.162),
        ...
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_YU,
                  crit_rate=0.105, atk_per=0.169, energe_recharge=0.091, hp_percent=0.053),
        ...
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_YU, hp_percent=0.128,
                  crit_rate=0.031, crit_damage=0.194, energe_recharge=0.052),
    ...
    ShengYiWu.PART_SHA: [
        ...
        ShengYiWu(ShengYiWu.HUA_HAI, ShengYiWu.PART_SHA, hp_percent=ShengYiWu.BONUS_MAX,
                  atk_per=0.152, energe_recharge=0.065, crit_rate=0.101, crit_damage=0.078),
        ShengYiWu(ShengYiWu.HUA_HAI, ShengYiWu.PART_SHA, hp_percent=ShengYiWu.BONUS_MAX,
        ...
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_SHA, hp_percent=ShengYiWu.BONUS_MAX,
                  crit_damage=0.319, def_v=19, crit_rate=0.031, energe_recharge=0.11),
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_SHA, hp_percent=ShengYiWu.BONUS_MAX,
        ...
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_SHA, elem_mastery=ShengYiWu.ELEM_MASTERY_MAIN,
                  crit_damage=0.117, crit_rate=0.128, hp=538, energe_recharge=0.045),
        ...
        ShengYiWu(ShengYiWu.FENG_TAO, ShengYiWu.PART_SHA, elem_mastery=ShengYiWu.ELEM_MASTERY_MAIN,
                  atk_per=0.047, energe_recharge=0.168, def_v=32, atk=37),
    ...
    ShengYiWu.PART_BEI: [
        ...
        ShengYiWu(ShengYiWu.JU_TUAN, ShengYiWu.PART_BEI, elem_bonus=ShengYiWu.BONUS_MAX, elem_type=ShengYiWu.ELEM_TYPE_LEI,
                  atk_per=0.082, atk=35, energe_recharge=0.045, crit_damage=0.225),
    ...
    ShengYiWu.PART_TOU: [
        ...
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_TOU, crit_rate=ShengYiWu.CRIT_RATE_MAIN,
                  energe_recharge=0.155, atk=14, hp=508, crit_damage=0.132),
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_TOU, hp_percent=ShengYiWu.BONUS_MAX,
                  def_per=0.066, crit_damage=0.234, crit_rate=0.113, energe_recharge=0.052), 
        ...
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_TOU, crit_rate=ShengYiWu.CRIT_RATE_MAIN,
                  def_per=0.073, energe_recharge=0.045, hp=478, crit_damage=0.264),
