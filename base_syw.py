...
all_syw = {
    ShengYiWu.PART_HUA: [
        ...
        ShengYiWu(ShengYiWu.JU_TUAN, ShengYiWu.PART_HUA,
                  crit_damage=0.14, def_per=0.131, crit_rate=0.066, atk=33),
    ...
    ShengYiWu.PART_YU: [
        ...
        ShengYiWu(ShengYiWu.HUA_HAI, ShengYiWu.PART_YU,
                  energe_recharge=0.155, hp_percent=0.041, hp=717, atk_per=0.047),
        ...
        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_YU, hp=448,
                  crit_damage=0.078, energe_recharge=0.311, hp_percent=0.053),
    ...
    ShengYiWu.PART_SHA: [
        ShengYiWu(ShengYiWu.JU_TUAN, ShengYiWu.PART_SHA, hp_percent=0.466,
                  hp=777, atk=33, crit_rate=0.058, crit_damage=0.07),
        ShengYiWu(ShengYiWu.JU_TUAN, ShengYiWu.PART_SHA, hp_percent=0.466,
                  energe_recharge=0.045, crit_damage=0.078, crit_rate=0.113, def_v=60),

        ShengYiWu(ShengYiWu.LIE_REN, ShengYiWu.PART_SHA, energe_recharge=0.518,
                  atk=14, crit_rate=0.14, def_v=37, crit_damage=0.148),
        ShengYiWu(ShengYiWu.LIE_REN, ShengYiWu.PART_SHA, hp_percent=0.466,
                  crit_rate=0.027, def_v=23, crit_damage=0.264, hp=478),
        ShengYiWu(ShengYiWu.LIE_REN, ShengYiWu.PART_SHA, elem_mastery=187,
                  def_per=0.073, crit_rate=0.128, crit_damage=0.148, hp_percent=0.041),

        ShengYiWu(ShengYiWu.HUA_HAI, ShengYiWu.PART_SHA,
                  crit_damage=0.21, hp=568, crit_rate=0.078, hp_percent=0.093),
        ShengYiWu(ShengYiWu.HUA_HAI, ShengYiWu.PART_SHA, hp_percent=0.466,
                  energe_recharge=0.052, crit_damage=0.202, elem_mastery=44, crit_rate=0.062),

        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_SHA, hp_percent=0.466,
        ...
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_SHA, elem_mastery=187,
                  atk_per=0.058, def_v=19, crit_damage=0.062, crit_rate=0.152),

        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_SHA, hp_percent=0.466,
                  def_v=21, crit_damage=0.187, crit_rate=0.089, atk_per=0.041),
        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_SHA, elem_mastery=187,
                  atk_per=0.14, def_v=35, crit_rate=0.062, atk=19),
        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_SHA, energe_recharge=0.518,
                  elem_mastery=23, crit_damage=0.218, def_v=44, crit_rate=0.07),
        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_SHA, elem_mastery=187,
                  hp_percent=0.053, energe_recharge=0.045, crit_rate=0.031, hp=1404),

        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_SHA, atk_per=0.466,
                  crit_rate=0.109, def_v=32, crit_damage=23.3, hp=209),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_SHA, elem_mastery=187,
        ...
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_SHA, hp_percent=0.466,
                  crit_rate=0.035, energe_recharge=0.214, atk=31, elem_mastery=19),

        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_SHA, atk_per=0.466,
                  elem_mastery=19, hp_percent=0.105, crit_rate=0.086, crit_damage=0.202),
        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_SHA, energe_recharge=0.518,
        ...
        ShengYiWu(ShengYiWu.ZHUI_YI, ShengYiWu.PART_SHA, hp_percent=0.466,
                  atk=19, crit_damage=0.14, elem_mastery=33, crit_rate=0.105),
        ShengYiWu(ShengYiWu.ZHUI_YI, ShengYiWu.PART_SHA, elem_mastery=187,
                  atk=27, crit_damage=0.218, energe_recharge=0.104, atk_per=0.041),

        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_SHA, hp_percent=0.466,
                  crit_rate=0.066, atk=33, elem_mastery=40, crit_damage=0.21),
        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_SHA, hp_percent=0.466,
                  def_v=37, energe_recharge=0.24, atk=19, crit_rate=0.07),
        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_SHA, elem_mastery=187,
        ...
        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_SHA, energe_recharge=0.518,
        ...
        ShengYiWu(ShengYiWu.CHEN_LUN, ShengYiWu.PART_SHA, hp_percent=0.466,
                  hp=448, crit_damage=0.311, def_per=0.073, elem_mastery=40),

        ShengYiWu(ShengYiWu.ZONG_SHI, ShengYiWu.PART_SHA, hp_percent=0.466,
                  atk=31, def_v=35, crit_rate=0.062, energe_recharge=0.104),
        ShengYiWu(ShengYiWu.ZONG_SHI, ShengYiWu.PART_SHA, energe_recharge=0.518,
                  hp=508, def_v=37, crit_damage=0.078, def_per=0.182),
        ShengYiWu(ShengYiWu.ZONG_SHI, ShengYiWu.PART_SHA, energe_recharge=0.518,
                  def_v=65, elem_mastery=37, hp_percent=0.047, atk=37),

        ShengYiWu(ShengYiWu.YUE_TUAN, ShengYiWu.PART_SHA, atk_per=0.466,
                  def_per=0.124, crit_rate=0.101, crit_damage=0.132, atk=19),

        ShengYiWu(ShengYiWu.FENG_TAO, ShengYiWu.PART_SHA, elem_mastery=187,
                  crit_rate=0.062, def_v=44, atk_per=0.047, energe_recharge=0.168),
        ShengYiWu(ShengYiWu.FENG_TAO, ShengYiWu.PART_SHA, elem_mastery=187,
                  atk_per=0.047, energe_recharge=0.168, def_v=323, atk=37),

        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_SHA, hp_percent=0.466,
                  energe_recharge=0.091, crit_rate=0.163, crit_damage=0.078, hp=239),
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_SHA, atk_per=0.466,
                  crit_rate=0.097, hp=209, crit_damage=0.202, def_v=42),
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_SHA, hp_percent=0.466,
                  elem_mastery=23, def_v=16, crit_damage=0.054, energe_recharge=0.259),
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_SHA, hp_percent=0.466,
                  crit_rate=0.031, def_v=23, crit_damage=0.295, energe_recharge=0.104),
    ],
    ShengYiWu.PART_BEI: [
        ShengYiWu(ShengYiWu.JU_TUAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_SHUI,
                  crit_damage=0.132, energe_recharge=0.11, def_v=62, def_per=0.073),

        ShengYiWu(ShengYiWu.LIE_REN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_BING,
                  crit_rate=0.105, elem_mastery=35, hp_percent=0.093, atk_per=0.082),
        ShengYiWu(ShengYiWu.LIE_REN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_SHUI,
                  atk=16, hp_percent=0.152, energe_recharge=0.175, hp=299),
        ShengYiWu(ShengYiWu.LIE_REN, ShengYiWu.PART_BEI, hp_percent=0.466,
                  crit_rate=0.031, crit_damage=0.218, elem_mastery=37, def_v=37),
        ShengYiWu(ShengYiWu.LIE_REN, ShengYiWu.PART_BEI, hp_percent=0.466,
                  elem_mastery=42, crit_damage=0.132, energe_recharge=0.104, def_v=46),
        ShengYiWu(ShengYiWu.LIE_REN, ShengYiWu.PART_BEI, hp_percent=0.466,
                  energe_recharge=0.045, crit_rate=0.105, atk=18, hp=657),

        ShengYiWu(ShengYiWu.HUA_HAI, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_BING,
                  atk=35, atk_per=0.111, elem_mastery=19, crit_rate=0.128),
        ShengYiWu(ShengYiWu.HUA_HAI, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_HUO,
        ...
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_SHUI,
                  crit_rate=0.109, def_v=32, hp=478, hp_percent=0.058),
        ShengYiWu(ShengYiWu.SHUI_XIAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_CAO,
                  crit_rate=0.101, elem_mastery=19, crit_damage=0.179, hp=209),

        ShengYiWu(ShengYiWu.SHA_SHANG, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_LEI,
                  crit_rate=0.07, atk_per=0.053, atk=54, crit_damage=0.132),

        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_BEI, elem_mastery=187,
                  atk_per=0.053, def_per=0.16, hp=0.058, energe_recharge=0.175),

        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_BEI, hp_percent=0.466,
                  hp=538, energe_recharge=0.11, atk=66, crit_damage=0.054),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_BING,
                  hp=239, crit_rate=0.066, atk_per=0.21, atk=37),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_BEI, hp_percent=0.466,
                  crit_rate=0.066, crit_damage=0.171, atk=27, energe_recharge=0.045),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_FENG,
                  crit_damage=0.148, atk=14, crit_rate=0.121, def_v=19),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_SHUI,
                  hp_percent=0.152, crit_damage=0.194, def_v=21, hp=239),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_HUO,
                  crit_rate=0.062, crit_damage=0.28, atk=14, def_v=16),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_BEI, elem_mastery=187,
                  crit_rate=0.035, crit_damage=0.194, hp=717, hp_percent=0.053),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_CAO,
                  hp_percent=0.163, energe_recharge=0.045, elem_mastery=40, crit_rate=0.074),

        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_BEI, elem_mastery=187,
                  atk=16, crit_rate=0.089, hp_percent=0.187, hp=239),
        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_LEI,
                  crit_damage=0.179, elem_mastery=91, atk=19, def_per=0.073),
        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_YAN,
                  crit_damage=0.14, def_per=0.233, crit_rate=0.027, atk_per=0.047),
        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_CAO,
                  elem_mastery=54, atk_per=0.053, atk=33, crit_damage=0.155),
        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_BEI, elem_mastery=187,
                  energe_recharge=0.149, hp=478, crit_damage=0.062, atk=33),
        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_BEI, atk_per=0.466,
                  crit_damage=0.218, crit_rate=0.066, def_v=39, energe_recharge=0.058),

        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_BEI, atk_per=0.466,
                  energe_recharge=0.214, atk=33, crit_damage=0.07, crit_rate=0.035),
        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_FENG,
                  hp_percent=0.093, def_v=16, energe_recharge=0.162, hp=538),
        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_SHUI,
                  hp=717, hp_percent=0.146, def_per=0.073, crit_damage=0.07),
        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_BEI, hp_percent=0.466,
                  energe_recharge=0.13, def_per=0.204, hp=568, def_v=16),

        ShengYiWu(ShengYiWu.CHEN_LUN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_CAO,
                  crit_damage=0.21,  elem_mastery=16, def_v=32, hp_percent=0.099),
        ShengYiWu(ShengYiWu.CHEN_LUN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_BING,
                  def_per=0.058, crit_rate=0.07, crit_damage=0.218, atk=33),

        ShengYiWu(ShengYiWu.QI_SHI_DAO, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_CAO,
                  elem_mastery=40, energe_recharge=0.058, crit_damage=0.241, hp_percent=0.047),

        ShengYiWu(ShengYiWu.ZONG_SHI, ShengYiWu.PART_BEI, atk_per=0.466,
                  crit_damage=0.194, def_per=0.124, def_v=42, energe_recharge=0.117),
        ShengYiWu(ShengYiWu.ZONG_SHI, ShengYiWu.PART_BEI, hp_percent=0.466,
                  energe_recharge=0.117, hp=568, def_v=58, crit_damage=0.07),
        ShengYiWu(ShengYiWu.ZONG_SHI, ShengYiWu.PART_BEI,
                  hp_percent=0.466, hp=269, def_v=72, elem_mastery=44, atk=14),

        ShengYiWu(ShengYiWu.YUE_TUAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_SHUI,
                  atk=29, crit_damage=0.241, hp=239, hp_percent=0.099),
        ShengYiWu(ShengYiWu.YUE_TUAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_HUO,
                  hp_percent=0.041, crit_damage=0.14, crit_rate=0.105, hp=568),
        ShengYiWu(ShengYiWu.YUE_TUAN, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_SHUI,
                  hp=538, crit_damage=0.078, atk_per=0.152, crit_rate=0.074),

        ShengYiWu(ShengYiWu.JUE_DOU_SHI, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_HUO,
                  atk_per=0.163, energe_recharge=0.065, atk=29, crit_damage=0.202),
        ShengYiWu(ShengYiWu.JUE_DOU_SHI, ShengYiWu.PART_BEI, hp_percent=0.466,
                  crit_rate=0.062, atk=14, energe_recharge=0.162, def_v=37),

        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_HUO,
                  crit_damage=0.256, def_per=0.139, energe_recharge=0.091, atk_per=0.058),
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_BING,
                  crit_damage=0.14, hp=956, def_v=21, energe_recharge=0.052),
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_SHUI,
                  atk=14, hp_percent=0.14, crit_damage=0.202, hp=269),
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_HUO,
                  crit_rate=0.031, energe_recharge=0.097, elem_mastery=21, crit_damage=0.256),
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_LEI,
                  energe_recharge=0.123, crit_damage=0.148, atk_per=0.105, crit_rate=0.066),
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_BEI, elem_mastery=187,
                  hp_percent=0.053, crit_damage=0.202, energe_recharge=0.052, crit_rate=0.097),
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_BEI, elem_bonus=0.466, elem_type=ShengYiWu.ELEM_TYPE_BING,
                  atk_per=0.192, hp=299, energe_recharge=0.11, atk=16),
    ],
    ShengYiWu.PART_TOU: [
        ShengYiWu(ShengYiWu.JU_TUAN, ShengYiWu.PART_TOU, hp_percent=0.466,
                  crit_damage=0.202, crit_rate=0.074, def_per=0.066, def_v=63),
        ShengYiWu(ShengYiWu.JU_TUAN, ShengYiWu.PART_TOU,
                  crit_rate=0.311, def_v=37, hp=239, atk=33, hp_percent=0.157),
        ShengYiWu(ShengYiWu.JU_TUAN, ShengYiWu.PART_TOU, crit_rate=0.311,
                  def_v=39, elem_mastery=44, hp=896, crit_damage=0.078),
        ShengYiWu(ShengYiWu.JU_TUAN, ShengYiWu.PART_TOU, crit_damage=0.622,
                  hp=478, hp_percent=0.111, atk_per=0.087, crit_rate=0.066),
        ShengYiWu(ShengYiWu.JU_TUAN, ShengYiWu.PART_TOU, crit_damage=0.622,
                  crit_rate=0.062, energe_recharge=0.097, def_v=32, def_per=0.132),

        ShengYiWu(ShengYiWu.HUA_HAI, ShengYiWu.PART_TOU, crit_damage=0.622,
                  atk=18, def_v=56, atk_per=0.105, crit_rate=0.093),
        ShengYiWu(ShengYiWu.HUA_HAI, ShengYiWu.PART_TOU, crit_damage=0.622,
                  def_per=0.058, hp=687, hp_percent=0.111, crit_rate=0.07),

        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_TOU, hp_percent=0.169,
                  crit_rate=0.078, elem_mastery=63, atk_per=0.053),
        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_TOU, hp=448,
                  atk=37, hp_percent=0.099, crit_damage=0.097),
        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_TOU, crit_rate=0.311,
                  def_v=21, crit_damage=0.14, atk=33, elem_mastery=58),
        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_TOU, def_per=0.058,
                  energe_recharge=0.227, atk_per=0.058, crit_damage=0.155),
        ShengYiWu(ShengYiWu.SHI_JIN, ShengYiWu.PART_TOU, crit_damage=0.622,
                  atk=33, crit_rate=0.101, def_v=16, atk_per=0.087),

        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_TOU, crit_damage=0.622,
                  elem_mastery=47, def_v=32, atk_per=0.152, crit_rate=0.066),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_TOU, hp_percent=0.466,
                  energe_recharge=0.142, atk=19, crit_damage=0.132, crit_rate=0.066),
        ShengYiWu(ShengYiWu.SHEN_LIN, ShengYiWu.PART_TOU, crit_damage=0.622,
                  atk=19, def_v=35, crit_rate=0.132, energe_recharge=0.052),

        ShengYiWu(ShengYiWu.JUE_YUAN, ShengYiWu.PART_TOU, crit_rate=0.311,
        ...
        ShengYiWu(ShengYiWu.ZHUI_YI, ShengYiWu.PART_TOU, crit_damage=0.622,
                  hp_percent=0.041, atk=18, elem_mastery=84, crit_rate=0.062),
        ShengYiWu(ShengYiWu.ZHUI_YI, ShengYiWu.PART_TOU, crit_rate=0.311,
                  elem_mastery=40, atk_per=0.053, energe_recharge=0.162, crit_damage=0.14),

        ShengYiWu(ShengYiWu.QIAN_YAN, ShengYiWu.PART_TOU, hp_percent=0.466,
                  hp=209, crit_rate=0.074, atk=18, crit_damage=0.241),

        ShengYiWu(ShengYiWu.CHEN_LUN, ShengYiWu.PART_TOU, crit_rate=0.311,
        ...
        ShengYiWu(ShengYiWu.ZONG_SHI, ShengYiWu.PART_TOU, crit_rate=0.311,
                  hp=299, atk=16, def_per=0.321, crit_damage=0.14),
        ShengYiWu(ShengYiWu.ZONG_SHI, ShengYiWu.PART_TOU, crit_damage=0.622,
                  def_per=0.109, crit_rate=0.148, atk_per=0.058, energe_recharge=0.058),
        ShengYiWu(ShengYiWu.ZONG_SHI, ShengYiWu.PART_TOU, crit_rate=0.311,
                  def_v=60, crit_damage=0.187, hp=269, elem_mastery=47),

        ShengYiWu(ShengYiWu.RU_LEI, ShengYiWu.PART_TOU, crit_rate=0.311,
                  hp=777, atk=27, crit_damage=0.132, elem_mastery=23),

        ShengYiWu(ShengYiWu.YUE_TUAN, ShengYiWu.PART_TOU, crit_rate=0.311,
                  hp=508, crit_damage=0.14, atk=45, atk_per=0.099),

        ShengYiWu(ShengYiWu.FENG_TAO, ShengYiWu.PART_TOU, crit_rate=0.311,
                  crit_damage=0.272, def_v=23, hp=538, hp_percent=0.041),

        ShengYiWu(ShengYiWu.JUE_DOU_SHI, ShengYiWu.PART_TOU, crit_rate=0.311,
        ...
        ShengYiWu(ShengYiWu.BING_TAO, ShengYiWu.PART_TOU, hp_percent=0.466,
