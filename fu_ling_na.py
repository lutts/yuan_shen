...
def calc_score(hp, e_bonus, q_bonus, crit_rate, crit_damage):
    ...
    fu_ren_damage_non_crit = hp * 6.87 / 100 * e_bonus * 13
    ...
    xun_jue_damage_non_crit = hp * 12.67 / 100 * e_bonus * 7
    ...
    pang_xie_damage_non_crit = hp * 17.61 / 100 * e_bonus * 4.5
    ...
    full_six_damage_non_crit = hp * 18 / 100 * q_bonus * 3 + hp * 33 / 100 * q_bonus * 3
...
def calculate_score(combine):
    ...
    ju_tuan_2_bonus = 0.2
    ju_tuan_4_bonus = ju_tuan_2_bonus + 0.25 + 0.25
    base_e_bonus = wan_ye_bonus + shui_shen_bonus + zhuan_wu_e_bonus + ye_lan_bonus
    base_q_bonus = wan_ye_bonus + shui_shen_bonus + ye_lan_bonus
    ...
    e_bonus = base_e_bonus + extra_water_bonus + ju_tuan_4_bonus
