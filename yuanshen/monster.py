...
class Monster:
    ...
    def get_kang_xin_cheng_shang(self):
        cur_kang_xin = self.__kang_xin - self.__jian_kang - self.buff_attrs.jian_kang
        if cur_kang_xin >= 0:
    ...
    def get_fang_yu_xi_shu(self):
        jian_fang = self.__jian_fang + self.buff_attrs.jian_fang
        ignore_defence_ratio = self.__ignore_defence_ratio + self.buff_attrs.ignore_fang
...
if __name__ == '__main__':
    monster1 = Monster(level=103, character_level=90, kang_xin=0.1)
    monster1.add_jian_kang(0.4 + 0.36)
    #monster1.add_jian_fang(0.2)
    dmg1 = monster1.attacked(1)
    print(monster1.attacked(1) )

    monster2 = Monster(level=100, character_level=90, kang_xin=0.1)
    monster2.add_jian_kang(0.3)
    #monster2.add_jian_fang(0.2)
